    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
           ...
           // else if(username.equals("admin") && password.equals("pass123")) {
                //Main.username = Integer.parseInt(username);
            //    loginFrame.dispose();
           //     new Admin_Form();

            //    Main.loginDetails(username);

            //}
            else if (Main.loginDetails(username,password).equals("true"))
            {
                //Main.loginDetails(username,password).equals("true admin") || Main.loginDetails(username,password).equals("true user") ||
                loginFrame.dispose();
                new Admin_Form();
            }
            else {
